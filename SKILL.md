...
## Before every edit
Run `quale core edit-context --format tool --files <file> --path <repo>`
...
## After every edit
Run `quale core verify-packet --format json --files <file> --path <repo>`
...
## Repo orientation
When first encountering a repo, run `quale agent orient --path <repo>`
